...
//       return NextResponse.json(
//         { success: false, message: "Employee email and login password are required" },
//         { status: 400 }
//       );
//     }
...
//     console.error(error);
//     return NextResponse.json(
//       { success: false, message: "Unable to create employee" },
//       { status: 500 }
//     );
//   }
// }
...
//       return NextResponse.json(
//         { success: false, message: "Only admins can delete employees" },
//         { status: 403 }
//       );
//     }
