...
export default function AddCustomerManagementDriverPage() {
    ...
    const [type, setType] = useState<DriverType>("Cab");
...
================================================= */}
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full appearance-none rounded-xl border border-slate-700 bg-slate-950 py-3 px-4 text-white outline-none transition focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500"
                            disabled={loading}
                        >
