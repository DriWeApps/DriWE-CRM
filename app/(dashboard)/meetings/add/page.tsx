            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="mt-3 max-h-60 overflow-y-auto rounded-lg border border-slate-700 bg-slate-900 p-3 space-y-2">

                            {employees.map((emp) => {

                                const checked = form.participantIds.includes(emp.employeeId);
