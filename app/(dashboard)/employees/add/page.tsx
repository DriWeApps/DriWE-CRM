...
export default function AddEmployeePage() {
    ...
    console.log("Selected Pages:", form.pageAccess);
    return (
                        ...
                        <section>
                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                {pages.map((page) => (
                                    <label
                                        key={page.id}
                                        className="flex items-center gap-3 rounded-xl border border-slate-700 bg-zinc-950 p-3 cursor-pointer hover:border-cyan-500"
                                    >
                                        <input
                                            type="checkbox"
                                            ...
                                            onChange={(e) => {
                                                if (e.target.checked) {
                                                    setForm({
                                                        ...form,
                                                        pageAccess: [...form.pageAccess, page.id],
                                                    });
                                                } else {
                                                    setForm({
                                                        ...form,
                                                        pageAccess: form.pageAccess.filter(
                                                            (p) => p !== page.id
                                                        ),
                                                    });
                                                }
